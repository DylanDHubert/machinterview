...
export function AISpeechIndicator({ isSpeaking, isSessionActive }: AISpeechIndicatorProps) {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="relative">
        {/* Outer ripple effect - only visible when speaking */}
        {isSpeaking && (
          <>
            <motion.div
      ...
      <p className={`mt-6 font-medium ${
        ...
        {!isSessionActive 
          ? "Click 'Start Broadcasting' to activate AI" 
          : isSpeaking 
            ? "AI is speaking..." 
            : "AI is listening..."}
      </p>
